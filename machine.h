...
# define BFI_FMACHINE_RESTART(k, o, d) o()BFI_FMACHINE_RESTART_##d(k)(
# define BFI_FMACHINE_RESTART_0(k) BFI_EMPTY, 0)BFI_REM
# define BFI_FMACHINE_RESTART_1(k) k

# define BFI_FCM_INNER_I_0(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_0, x)
# define BFI_FCM_INNER_I_1(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_1, x)
# define BFI_FCM_INNER_I_2(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_2, x)
# define BFI_FCM_INNER_I_3(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_3, x)
# define BFI_FCM_INNER_I_4(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_4, x)
# define BFI_FCM_INNER_I_5(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_5, x)
# define BFI_FCM_INNER_I_6(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_6, x)
# define BFI_FCM_INNER_I_7(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_7, x)
# define BFI_FCM_INNER_I_8(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_8, x)
# define BFI_FCM_INNER_I_9(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_9, x)
# define BFI_FCM_INNER_I_10(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_10, x)
# define BFI_FCM_INNER_I_11(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_11, x)
# define BFI_FCM_INNER_I_12(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_12, x)
# define BFI_FCM_INNER_I_13(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_13, x)
# define BFI_FCM_INNER_I_14(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_14, x)
# define BFI_FCM_INNER_I_15(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_15, x)
# define BFI_FCM_INNER_I_16(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_16, x)
# define BFI_FCM_INNER_I_17(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_17, x)
# define BFI_FCM_INNER_I_18(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_18, x)
# define BFI_FCM_INNER_I_19(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_19, x)
# define BFI_FCM_INNER_I_20(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_20, x)
# define BFI_FCM_INNER_I_21(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_21, x)
# define BFI_FCM_INNER_I_22(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_22, x)
# define BFI_FCM_INNER_I_23(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_23, x)
# define BFI_FCM_INNER_I_24(x) BFI_FMACHINE_RESTART(BFI_FCM_INNER_C_24, x)

# define BFI_FCM_OUTER_I_0(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_1, x)
# define BFI_FCM_OUTER_I_1(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_2, x)
# define BFI_FCM_OUTER_I_2(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_3, x)
# define BFI_FCM_OUTER_I_3(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_4, x)
# define BFI_FCM_OUTER_I_4(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_5, x)
# define BFI_FCM_OUTER_I_5(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_6, x)
# define BFI_FCM_OUTER_I_6(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_7, x)
# define BFI_FCM_OUTER_I_7(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_8, x)
# define BFI_FCM_OUTER_I_8(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_9, x)
# define BFI_FCM_OUTER_I_9(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_10, x)
# define BFI_FCM_OUTER_I_10(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_11, x)
# define BFI_FCM_OUTER_I_11(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_12, x)
# define BFI_FCM_OUTER_I_12(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_13, x)
# define BFI_FCM_OUTER_I_13(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_14, x)
# define BFI_FCM_OUTER_I_14(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_15, x)
# define BFI_FCM_OUTER_I_15(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_16, x)
# define BFI_FCM_OUTER_I_16(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_17, x)
# define BFI_FCM_OUTER_I_17(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_18, x)
# define BFI_FCM_OUTER_I_18(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_19, x)
# define BFI_FCM_OUTER_I_19(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_20, x)
# define BFI_FCM_OUTER_I_20(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_21, x)
# define BFI_FCM_OUTER_I_21(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_22, x)
# define BFI_FCM_OUTER_I_22(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_23, x)
# define BFI_FCM_OUTER_I_23(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_24, x)
# define BFI_FCM_OUTER_I_24(x) BFI_FMACHINE_RESTART(BFI_FCM_OUTER_C_25, x)
...
# define BFI_FMACHINE(v, f, d) BFI_FMACHINE_G(BFI_TUPLE, v, f, d)
# define BFI_FMACHINE_O(v, f, d) BFI_FMACHINE_G(BFI_LEFT, v, f, d)()
# define BFI_FMACHINE_V(v, f, d) BFI_FMACHINE_G(BFI_RIGHT, v, f, d)
# define BFI_FMACHINE_G(m, v, f, d) m(BFI_FMACHINE_R((f)((BFI_FLINEAR_ENTRANCE_A, v, d, 6stop))(~)(6id,~)))
...
# define BFI_EAT_CONT(d, k) BFI_IFN(BFI_BOTTOM_TEST_##k)(BFI_EMPTY, BFI_EAT_CONT_NEXT)(
# define BFI_EAT_CONT_NEXT() BFI_EAT_CONT(

# define BFI_FINST_6stop(f, v, d, t) BFI_EMPTY, 0)BFI_ID(v)BFI_EAT_CONT_NEXT(
